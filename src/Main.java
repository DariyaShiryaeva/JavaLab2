  ...
  public static void main(String[] args) {
    ...
    switch (n) {
      case 1:
        ...
        System.out.println(kleopatra1);
        System.out.println(pushkin1);
        System.out.println(mayakovsky1);
        System.out.println("\nРаботает!\n");

        String input1 = checkInput.getYN(scanner);
        Name name = checkInput.nameByHand(scanner);
        System.out.println("Объект класса Name, созданный Вами: " + name);
      ...
      case 2:
        ...
        System.out.println(kleopatra2);
        System.out.println(pushkin2);
        System.out.println(mayakovsky2);

        String input2 = checkInput.getYN(scanner);
        PersonWithName pwn = checkInput.pwnByHand(scanner);
        System.out.println("Объект класса PersonWithName, созданный Вами: " + pwn);
        break;
      ...
      case 3:
        ...
        System.out.println(ivanName);
        System.out.println(petrName);
        ...
        System.out.println("Объект, созданный Вами: " + Dad);
        ...
        System.out.println("Объект, созданный Вами: " + Son);
        break;
      ...
      case 5:
        ...
        System.out.println("Объект класса Name, созданный Вами: " + name5);
        break;
      ...
      case 6:
        ...
        System.out.println("Объект, созданный Вами: " + Father);
        ...
        System.out.println("Объект, созданный Вами: " + Kid);
        break;
      ...
      case 7:
        ...
        System.out.println("Объект класса Name, созданный Вами: " + yourCat);
